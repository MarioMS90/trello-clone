...
import { isCardData, TCardData } from '@/modules/board/types/board';
import { createPortal } from 'react-dom';
import { cn } from '@/modules/common/utils/utils';
import { isShallowEqual } from '@/modules/common/utils/is-shallow-equal';
import DescriptionIcon from '@/modules/common/components/icons/description';
...
import { blockCardDraggingAttr } from '@/modules/common/constants/constants';
import { useRouter } from 'next/navigation';
import { useCardMutation } from '@/modules/card/hooks/useCardMutation';
