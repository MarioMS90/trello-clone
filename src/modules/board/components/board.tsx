...
import { isCardData, isListData, TCardData, TListData } from '@/modules/board/types/board';
import { TCard, TList } from '@/modules/common/types/db';
import { useCallback, useEffect, useRef } from 'react';
import { List } from '@/modules/list/components/list';
import { generateRank } from '@/modules/common/utils/utils';
...
import { updateCard } from '@/modules/card/lib/actions';
import { notFound } from 'next/navigation';
import { CreateList } from '@/modules/list/components/create-list';
